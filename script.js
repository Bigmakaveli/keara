...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const i18n = {
    he: {
      ...
      'about.p1': 'המסעדה הביתית שלנו נולדה מתוך אהבה גדולה לבישול ביתי ומסורות משפחתיות. בשנת 2005 החליט מייסד המסעדה, שף Jol Rhayel, לפתוח מקום שיזכיר לכל אחד ואחת את הטעמים של בית אמא. Jol גדל בבית שבו סירי המרק תמיד היו על האש והריחות נעו בין מאפים חמים לקפה טרי. לאחר שנים רבות בתחום הקולינריה, הוא החליט להחזיר את הבישול הפשוט והטעים למרכז הבמה.',
