...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const i18n = {
    he: {
      ...
      'cta.banner.desc': 'שלחו לנו הודעה בוואטסאפ ונרכיב לכם קערת סלט אישית וטרייה.',
    ...
    ar: {
      ...
      'cta.banner.desc': 'أرسلوا لنا رسالة عبر واتساب ونحضّر لكم سلطة شخصية وطازجة.',
    ...
    en: {
      ...
      'cta.banner.desc': 'Send us a WhatsApp message and we’ll prepare your fresh, custom salad.',
