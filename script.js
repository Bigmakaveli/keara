...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const i18n = {
    he: {
      ...
      'services.bullets.1': 'המסעדה הראשונה בישראל שהתמחתה בהרכבת סלטים אישיים.',
      'services.bullets.2': 'שימוש בחומרי גלם מקומיים, טריים ובריאים.',
      'services.bullets.3': 'כל אחד יכול ליצור את הקערה שמתאימה לו – טבעונית, חלבונית, קטוגנית ועוד.',
      'services.bullets.4': '',
  ...
  const applyTranslations = (lang) => {
    ...
    // Keep document direction fixed to prevent reflow across languages
    // document.documentElement.dir remains as set in the HTML (e.g., 'rtl')
