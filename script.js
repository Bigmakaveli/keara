...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const i18n = {
    he: {
      ...
      'about.p1': 'המסעדה הביתית שלנו נולדה מתוך אהבה גדולה לבישול ביתי ומסורות משפחתיות. בשנת 2005 החליט מייסד המסעדה, שף אחמד אל‑חאלדי, לפתוח מקום שיזכיר לכל אחד ואחת את הטעמים של בית אמא. אחמד גדל בבית שבו סירי המרק תמיד היו על האש והריחות נעו בין מאפים חמים לקפה טרי. לאחר שנים רבות בתחום הקולינריה, הוא החליט להחזיר את הבישול הפשוט והטעים למרכז הבמה.',
      ...
      'founder.caption': 'המייסד שלנו, שף אחמד אל‑חאלדי',
    ...
    ar: {
      ...
      'about.title': 'من نحن',
      'about.p1': 'وُلد مطعمنا المنزلي من حب كبير للطبخ المنزلي والتقاليد العائلية. في عام 2005 قرر مؤسس المطعم، الشيف أحمد الخالدي، افتتاح مكان يذكّر كل واحد وكل واحدة بنكهات بيت الأم. نشأ أحمد في بيت كانت قدور الشوربة فيه دائماً على النار وكانت الروائح تتنقل بين مخبوزات ساخنة وقهوة طازجة. بعد سنوات عديدة في مجال الطهي، قرر أن يعيد الطبخ البسيط واللذيذ إلى الواجهة.',
      ...
      'founder.caption': 'مؤسسنا، الشيف أحمد الخالدي',
    ...
    en: {
      ...
      'about.p1': 'Our home restaurant was born out of a great love for home cooking and family traditions. In 2005, the restaurant\'s founder, Chef Ahmad Al-Khalidi, decided to open a place that would remind everyone of the flavors of home. Ahmad grew up in a house where the soup pots were always on the fire and the smells moved between hot pastries and fresh coffee. After many years in the culinary field, he decided to bring simple and delicious cooking back to the forefront.',
      ...
      'founder.caption': 'Our Founder, Chef Ahmad Al-Khalidi',
      'services.title': 'Additional Services',
      'services.p1': 'Not only good food awaits you with us – we are also happy to offer professional laundry services within the restaurant complex. You can bring your clothes for washing while you enjoy a meal, and receive them clean and fragrant when you finish. The service is carried out by an experienced team using advanced machines, so you can be sure that the clothes are in good hands.',
